...
export const Gastos = () => {
    ...
    return (
        <div className="p-8">
            ...
            <div className="m-3 bg-gray-50 flex p-2 justify-between"> <h1>tipo</h1><h1>estructura</h1><h1>importe</h1><h1>detalle</h1><h1>metodo</h1><h1>responsable</h1><h1>fecha</h1><button onClick={() => show(e.id)} className="bg-gray-50 text-gray-50 font-bold py-2 px-4 rounded">X</button></div>
